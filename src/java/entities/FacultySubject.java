...
@NamedQueries({
    ...
    @NamedQuery(name = "FacultySubject.findByBatchFS", query = "SELECT f FROM FacultySubject f WHERE f.division = :division AND f.idSubject = :idSubject AND f.batch = :batch"),
